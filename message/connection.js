...
start(`1`,`Connecting...`)
 ...
 conn.sendMessage(`${nomerOwner}@s.whatsapp.net`, {text: `⚠️ Botz Tersambung Kembali, Terimakasih sudah memakai script bot ini!
_jika kamu ingin membeli script bot ini dengan no enc_
silakan chat number owner di bawah ini 👇

By : LanaX
Nomer Developer: wa.me/6281775445373

*Join Saluran Kami Untuk mendapatkan info selanjutnya*: https://whatsapp.com/channel/0029VagJFAn1dAwCQYKodZ14`})
